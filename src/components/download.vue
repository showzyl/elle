<template>
  <!--<div class="container">-->
    ...
    <!--<div class="fl">-->
      <!--&lt;!&ndash;<img class="buyer-close" id="buyer_close" src="//www.elleshop.com.cn/catalog/view/theme/mobile/image/buyer-close.jpg">&ndash;&gt;-->
    <!--</div>-->
...
<style media="screen" lang="scss" scoped>
  .download{
    ...
    width: 100%;
    height: 2rem;
    background-image: url(../assets/img/lihuizhen.jpg);
  ...
  .btn-down{
    background-image: url(../assets/img/btn-down.jpg);
    background-repeat: no-repeat;
  ...
  /*}*/
  /*.buyer-head-main p {*/
    /*font-family: "PingFangSC Medium", "微软雅黑","Microsoft Yahei";*/
    /*font-size: .28986rem;*/
  /*}*/
