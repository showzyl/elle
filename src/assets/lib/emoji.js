/**
 *
 * modify by showzyl 17.4.25
 * 
 * https://github.com/coocy/emoji
 * 
 * @type {{reg: RegExp, emojiPath: string, maxSize: number, emoji: Emoji.emoji, trans: Emoji.trans, _escapeToUtf32: Emoji._escapeToUtf32, _convertStringToUnicodeCodePoints: Emoji._convertStringToUnicodeCodePoints}}
 */
...
var Emoji = {
	...
	trans:  function(text) {
		...
		// console.log('Emoji.reg: ', Emoji.reg);
